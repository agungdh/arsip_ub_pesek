    ...
    <div class="card">
        ...
        <div class="body">
            <form method="post" action="<?php echo base_url('detail_kontrak/aksi_ubah'); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <select class="form-control show-tick" data-live-search="true" name="data[id_cv_pt]" id="id_cv_pt">
                        ...
                        foreach ($this->db->get('cv_pt')->result() as $item) {
                            ?>
                            <option <?php echo $item->id_cv_pt == $data['detail_kontrak']->id_cv_pt ? 'selected' : null ?> value="<?php echo $item->id_cv_pt; ?>"><?php echo $item->nama_perusahaan; ?></option>
                            <?php
                        }
                        ?>
                    </select>
                ...
                <div class="form-group">
                    <div class="form-line">
                        <input placeholder="Masukkan Berkas" type="file" name="berkas" id="berkas" class="form-control">
                    </div>
                </div>
